export const cover = [
  {
    bold: 'Sambang Kota',
    text:
      'merupakan upaya desentralisasi penyelenggaraan USF sebagai salah satu rangkaian forum ketujuh dalam skala yang lebih kecil dan bentuk yang lebih intim di berbagai kota di Indonesia. Sambang Kota merupakan manifestasi usaha untuk menyebarkan semangat inklusivitas dan mendorong ruang demokratis dalam bertukar pengetahuan dan mendiskusikan berbagai isu perkotaan, gagasan yang masih kami dukung secara konsisten hingga tahun ketujuh penyelenggaraannya.',
  },
  'Pada November dan Desember 2019, serta Februari 2020, kami menyelenggarkan forum Sambang Kota di tiga kota di Indonesia: Surabaya, Solo, dan Makassar. Ketiga forum didukung oleh kolaborasi dengan berbagai organisasi masyarakat sipil dan inisiatif lokal, mengangkat berbagai isu hangat di masing-masing kota dan menjadi ruang berjejaring untuk mendiskusikan solusi di masa mendatang.',
]
