...
import Component from './../../labs/Component/Component'
import Portal from './../../labs/Portal/Portal'
...
let DialogOverlay = React.forwardRef(
  ({ isOpen = true, onDismiss = k, initialFocusRef, onClick, onKeyDown, ...props }, forwardedRef) => (
...
let DialogContent = React.forwardRef(({ onClick, onKeyDown, ...props }, forwardedRef) => (
  <div
    aria-modal="true"
...
let Dialog = ({ isOpen, onDismiss = k, initialFocusRef, ...props }) => (
  <DialogOverlay isOpen={isOpen} onDismiss={onDismiss} initialFocusRef={initialFocusRef}>
    <DialogContent {...props} />
  </DialogOverlay>
)
