...
const htmlSerializer = (type, element, content, children, key) => {
  ...
  switch (type) {
    case Elements.heading1:
      return (
        <Text heading1 as="h1" className={styles.heading1} key={key}>
          {children}
        </Text>
      )
    ...
    case Elements.heading2:
      return (
        <Text heading2 as="h2" className={styles.heading2} key={key}>
          {children}
        </Text>
      )
    ...
    case Elements.heading3:
      return (
        <Text heading3 as="h3" className={styles.heading3} key={key}>
          {children}
        </Text>
      )
    ...
    case Elements.heading4:
      return (
        <Text heading4 as="h4" className={styles.heading4} key={key}>
          {children}
        </Text>
      )
    ...
    case Elements.heading5:
      return (
        <Text heading5 as="h5" className={styles.heading5} key={key}>
          {children}
        </Text>
      )
    ...
    case Elements.heading6:
      return (
        <Text heading6 as="h6" className={styles.heading6} key={key}>
          {children}
        </Text>
      )
    ...
    case Elements.paragraph:
      ...
      return (
        <Text large className={styles.paragraph} as="p" key={key}>
          {children}
        </Text>
      )
    ...
    case Elements.preformatted:
      return (
        <pre className={styles.preformatted} key={key}>
          {children}
        </pre>
      )
    ...
    case Elements.strong:
      return (
        <strong className={styles.strong} key={key}>
          {children}
        </strong>
      )
    ...
    case Elements.em:
      return (
        <em className={styles.emphasis} key={key}>
          {children}
        </em>
      )
    ...
    case Elements.listItem:
      return (
        <Text large className={styles.listItem} as="li" key={key}>
          {children}
        </Text>
      )
    ...
    case Elements.list:
      return (
        <ul className={styles.listContainer} key={key}>
          {children}
        </ul>
      )
    ...
    case Elements.oList:
      return (
        <ol className={styles.oListContainer} key={key}>
          {children}
        </ol>
      )
